...
try {
    ...
    $tablesToDrop = [
        ...
        'job_applications', 'job_questions'
    ];
    ...
    if ($stmt->fetchColumn() == 0) {
        ...
        echo "Sample staff (5 employees) seeded.<br>";
    }
    ...
    if ($stmt->fetchColumn() == 0) {
        $jobs = [
            ['Senior Bartender', 'Bar & Beverage', 'Full-Time', 'Addis Ababa', "We are looking for an experienced Senior Bartender to manage our premium bar.\n\nRequirements:\n- 3+ years of bartending experience\n- Knowledge of Ethiopian and international drinks\n- Strong customer service skills\n- Ability to work evenings and weekends", date('Y-m-d', strtotime('+30 days')), 'Open'],
            ['Kurt Specialist Chef', 'Kitchen', 'Full-Time', 'Addis Ababa', "Join our kitchen team as a Kurt Specialist Chef preparing authentic Ethiopian raw meat dishes.\n\nRequirements:\n- Experience in Ethiopian meat preparation\n- Food safety certificate\n- Team player with a passion for traditional cuisine\n- Willing to work split shifts", date('Y-m-d', strtotime('+25 days')), 'Open'],
            ['Restaurant Supervisor', 'Management', 'Full-Time', 'Addis Ababa', "We need a skilled Restaurant Supervisor to oversee daily operations at Sheger Kurt.\n\nRequirements:\n- 5+ years in restaurant management\n- Strong leadership and communication skills\n- Proficiency in inventory and staff scheduling\n- Customer-oriented mindset", date('Y-m-d', strtotime('+20 days')), 'Open'],
            ['Delivery Rider', 'Delivery', 'Part-Time', 'Addis Ababa', "We are hiring Delivery Riders to fulfill our growing delivery orders.\n\nRequirements:\n- Valid motorcycle license\n- Knowledge of Addis Ababa routes\n- Reliable and punctual\n- Smartphone for order management app", date('Y-m-d', strtotime('+15 days')), 'Open'],
        ];
        ...
        echo "Sample jobs (4 positions) seeded.<br>";
    }
